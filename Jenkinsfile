                ...
                withCredentials([[
                    ...
                    script {
                        ...
                        if (ec2Info == 0) {
                            ...
                            bat(script: "aws ec2 describe-instances --region ${AWS_REGION} --instance-ids ${EC2_INSTANCE_ID} --query 'Reservations[0].Instances[0].PublicDnsName' --output text > output.txt")
