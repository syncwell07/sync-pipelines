                ...
                withCredentials([[
                    ...
                    script {
                        ...
                        if (ec2Info == 0) {
                            ...
                            bat(script: "aws ec2 describe-instances --region ${env.AWS_REGION} --instance-ids ${env.INSTANCE_ID} --query 'Reservations[0].Instances[0].PublicDnsName' --output text > output.txt")
                            env.EC2_PUBLIC_DNS = readFile('output.txt').trim()
